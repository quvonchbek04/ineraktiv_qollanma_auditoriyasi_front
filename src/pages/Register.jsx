// pages/Register.jsx — Ro'yxatdan o'tish sahifasi (ochiq, hamma uchun)
...
export default function Register() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
      const result = await register(form.full_name.trim(), form.password);
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Yangi akkaunt yarating</p>
        ...
        <p style={{ textAlign: 'center', marginTop: '16px', fontSize: '14px', color: '#666' }}>
          Akkauntingiz bormi?{' '}
          <Link to="/login" style={{ color: '#4f46e5', fontWeight: 600 }}>Kirish</Link>
        </p>
      </div>
    </div>
  );
